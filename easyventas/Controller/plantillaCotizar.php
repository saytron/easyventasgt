...
class PLANTILLA_COTIZAR extends FPDF
{
    ...
    var $usuario = '';
    function recuperarDatosFactura($fechaFormato,$CorrelativoInterno,$usuario){
    ...
    function recuperarDatosTotales($txIzquierda, $txDerecha, $txtotal)
    {
    ...
    public function header()
    {
        ...
        $this->Cell(60, 5, "Documento Tributario Electronico", 0, 1, 'C');
        ...
        $this->Ln(-35);
        $this->Cell(172, 4, utf8_decode('COTIZACION'), 0, 1, 'R');
        $this->Ln(3);
        $this->SetFont('Arial', 'B', 10);
...
$this->SetTextColor(0, 0, 0);
$this->Cell($cellWidth2, 6, $this->nombre, 0, 1, 'L');
$this->SetFont('Courier', 'B', 11);
$this->SetTextColor(252, 26, 4);
