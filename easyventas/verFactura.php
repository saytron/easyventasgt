        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="card bg-light">
              ...
              <div class="input-group mb-4">
              <select class="btn btn-info input-group-text" name="region" width="100px" id="opcFactura">
                  <option class="dropdown-toggle" value="0">NIT</option>
                  <option class="dropdown-toggle" value="1">CUI</option>
                  <option class="dropdown-toggle" value="2">PASSPORT</option>
  ...
  <script>
    $(document).ready(function() {
      ...
      $(".generarFactura").click(function(e) {
        ...
        let opcFactura = document.getElementById("opcFactura").value
        if(taxCode == '' || taxName == '' || taxAddress == '' || opcFactura == ''){
          Swal.fire(
            'Cambos vacios!',
    ...
    btnNit.onclick = async () => {
      ...
      let opcFactura = document.getElementById("opcFactura").value
      console.log(opcFactura);
      spinner();
      const datos = {
        nitFel: arg_nitFel,
        opcFactura: opcFactura
      };
      const datosCodificados = JSON.stringify(datos);
      const url = "Controller/buscarNitSat.php?nit=" + arg_nitFel + "&opcFactura=" + opcFactura;
