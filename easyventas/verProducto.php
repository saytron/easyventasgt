    ...
    <div class="container-fluid card shadow mt-2 card-principal-page">
      ...
      <div class="content-principal-page">
        <div class="verDetalleProducto">
          ...
          <div class="dtes">
            <button type="button" class="btn btn-color-blue text-light position-relative">
              DTES
              <span id="dteDisponible" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">
