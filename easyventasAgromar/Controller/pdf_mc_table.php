...
class PDF_MC_Table extends FPDF
{
    ...
    public function header()
    {
        ...
        $this->Cell(60, 5, "", 0, 1, 'C'); //Documento tributario electronico
        ...
        $this->Ln(-35);
        $this->Cell(178, 4, 'SALIDA DE BODEGA', 0, 1, 'R');
        $this->Ln(3);
        $this->SetFont('Arial', 'B', 10);
...
$this->SetFont('Courier', 'B', 11);
$this->SetTextColor(252, 26, 4);
$this->Cell(165, 6, 'Nit: ', 0, 0, 'R');
$this->SetTextColor(0, 0, 0);
$this->Cell(21, 6, $this->nit, 0, 1, 'R');
$this->SetY(72);
    ...
    function Footer()
    {
        ...
        $this->SetFont('Arial', 'B', 10);
        $this->Cell(188, 6, 'No genera derecho a crédito fiscal', 0, 1, 'R');

        $this->SetFont('Arial', 'B', 9);
        $this->SetTextColor(29, 62, 96);
        $this->Cell(115, 5, 'NO. DE AUTORIZACION: ' . $this->sat_authorization . ', ', 0, 0, 'L');
        $this->Cell(54, 5, 'CERTIFICADOR: ' . $this->satCertifier . ' NIT: ' . $this->taxCode, 0, 1, 'L');
        $this->Cell(55, 5, 'FECHA DE AUTORIZACION: ' . $this->certification_date, 0, 1, 'L');
    }
}
