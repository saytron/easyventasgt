...
r.codigo = a.repuesto_codigo and d.detalle_repuesto_iddetalle_repuesto = a.iddetalle_repuesto AND r.codigo = d.repuesto_codigo AND d.usuario_codigo = '$cod' and d.venta_idventa = $id";
		...
		public function cargarVentasEnvios($cod,$id){
			...
			$modelo = new Conexion();
			$conexion = $modelo->get_connection();
			$sql = "select d.iddetenvio as id, a.iddetalle_repuesto, r.codigo, r.descripcion, d.cantidad, d.descripcion as detalleProducto, d.fecha, d.precio_venta, d.facturado as estado, r.precio as precio_publico, d.usuario_codigo as usuario, d.envio_idventa as idventa from repuesto r, detenvio d, detalle_repuesto a WHERE
