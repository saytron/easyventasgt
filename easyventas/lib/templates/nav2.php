        ...
        <nav class="sidebar-main">
          ...
          <div id="sidebar-menu">
            <ul class="sidebar-links" id="simple-bar">
              ...
              <li class="sidebar-list">
                <?php if ($pagina == 5) { ?>
                  <label class="badge badge-danger">1</label><a class="sidebar-link sidebar-title" href="#"><i data-feather="trending-up"></i><span>Reportes </span></a>
                  <ul class="sidebar-submenu">
                ...
                <?php } else { ?>
                  ...
                  ?>
                      ...
                      <ul class="sidebar-submenu">
                        ...
                        <li><a data-bs-toggle="modal" data-bs-target="#modalNuevaBodega">CREAR UBICACION</a></li>
              ...
              <li class="sidebar-list">
                ...
                <ul class="sidebar-submenu">
                  ...
                  <li><a href="ventasUsuario">VENTAS DIARIAS</a></li>
                  <li><a href="verFactura">FACTURACION</a></li>
                </ul>
              </li>
              <li class="sidebar-list">
                <label class="badge badge-danger">3</label><a class="sidebar-link sidebar-title" href="#"><i data-feather="zap"></i><span>Herramientas</span></a>
                <ul class="sidebar-submenu">
