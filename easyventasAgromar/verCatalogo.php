...
check
    ...
    <script>
        $(document).ready(function() {
          ...
          `
            ...
            $('#tabla tbody').on('click', '.detalles3', function() {
                ...
                document.getElementById('tipoCatalogo').value = data.type;
        ...
        async function generarPdfCatalogo() {
            ...
            window.open("Controller/generarCatalogo.php?idCatalogo=" + arg_idCatalogo + "&totalCatalogo=" + arg_totalCatalogo + "&tituloCatalogo=" + tituloCatalogo + "&tipoCatalogo=" + tipoCatalogo, "catalogo", "width=900, height=600");
