...
<!--Modal para iniciar inventario -->
<!-- Modal -->
<div class="modal fade" id="modalIniciarInventario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h2 class="text-danger">Iniciar Inventario</h2>
        <p class="text-primary">Realmente quieres iniciar un inventario nuevo!</p>
      </div>
      <div class="modal-footer bg-info">
        <button type="button" class="btn btn-danger" onclick="iniciarInventario();" data-bs-dismiss="modal">Iniciar</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-footer modal-footer-detalle">
        <?php if ($rol == 2) { ?>
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalNuevoDetalle" alt="Agregar Detalle" title="Agregar Detalle"><i class="material-icons">queue</i></button>
        <?php } ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="formActualizarDetalle">
          ...
          <div class="mb-3 input-group">
          <input type="hidden" id="bodegaName" name="bodegaName" class="form-control" placeholder="Bodega..." aria-label="Recipient's username" aria-describedby="basic-addon2" style="text-transform:uppercase;">
          ...
          <input class="form-control input-sm" type="hidden" id="oldCantidadAcDet" placeholder="Cantidad" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
      ...
      <div class="modal-footer bg-info">
        <button type="button" class="cerrar btn btn-danger" onclick="actualizar_detalleProductoInventario();" data-bs-dismiss="modal">ACTUALIZAR</button>
      </div>
    </div>
  </div>
</div>
